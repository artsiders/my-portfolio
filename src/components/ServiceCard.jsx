...
const ServiceCard = ({ index, title, icon, description, image }) => {
  ...
  return (
    <>
      <div
        className="relative cursor-pointer service-card bg-[#f7f7f7] dark:bg-tertiary rounded-[20px] p-4 min-h-[140px] flex justify-evenly items-center flex-col border-2 border-white dark:border-transparent w-full xs:w-[230px]"
        data-aos="fade-up"
